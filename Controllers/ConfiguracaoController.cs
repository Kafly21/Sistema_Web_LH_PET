...
namespace SP_03_UC08_LH_PET_WEB.Controllers
{
    ...
    public class ConfiguracaoController : Controller
    {
        ...
        {
            // Busca a configuração única da clínica (Sempre o ID 1)
        ...
        public async Task<IActionResult> Salvar(ConfiguracaoClinica model,
        List<string> DiasSelecionados)
        {
            ...
            // Ignoramos a validação da string vazia de DiasTrabalho pois montamos ela manualmente acima

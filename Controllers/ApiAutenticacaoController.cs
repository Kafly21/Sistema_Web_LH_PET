...
namespace SP_03_UC08_LH_PET_WEB.Controllers
{
    ...
    {
        private readonly ContextoBanco _contexto; private readonly IConfiguration _configuracao;
        ...
        try
        {
            var usuarioExiste = await
            _contexto.Usuarios.AnyAsync(u => u.Email == dto.Email);

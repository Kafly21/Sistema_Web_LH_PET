...
using LH_PET_WEB.Services; // Necessário para o IEmailService
...
namespace LH_PET_WEB.Controllers
{
    ...
    public class VendasController : Controller
    {
        ...
        public async Task<IActionResult> Finalizar([FromBody] CheckoutRequest request)
        {
            ...
            try
            {
                ...
                await _contexto.SaveChangesAsync(); await transaction.CommitAsync();
        ...
        public async Task<IActionResult> Recibo(int id)
        {
            ...
            .Include(v => v.Usuario)
            .Include(v => v.Itens)
            .ThenInclude(i => i.Produto) // Traz os detalhes do produto dentro do item
        ...
        public async Task<IActionResult> EnviarPorEmail(int id, string emailCliente)
        {
            ...
            if(enviado) TempData["Sucesso"] = "Recibo enviado por e-mail com sucesso!"; else TempData["Erro"] = "Falha ao enviar o e-mail. Verifique a conexão.";
    ...
    {
        public int ProdutoId { get; set; } public int Quantidade { get; set; }
    }
}
